...
//#import "MBProgressHUD.h"
 ...
 1.导航的页面pop到没导航的页面，导航栏可能会出现黑色，特别是在侧滑返回手势触发的时候；
  ...
  4.关于有的页面想从y是0开始布局，有的页面想从y是64开始布局，为了避免出现其他未知bug，尽量不用使用setTranslucent:方法，全局setTranslucent:NO即可，而使用解决方案的第2个方案在导航代理方法中setNavigationBarHidden
...
@property (assign, nonatomic) BOOL navigationBarHidden;//导航栏是否隐藏
